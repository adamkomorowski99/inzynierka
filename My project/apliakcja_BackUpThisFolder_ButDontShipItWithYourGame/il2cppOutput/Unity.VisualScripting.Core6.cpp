...
IL_001d:
	...
	}
	{
		...
		NullCheck(L_23);
		Type_t* L_25;
		L_25 = VirtualFuncInvoker1< Type_t*, TypeU5BU5D_t97234E1129B564EB38B8D85CAC2AD8B5B9522FFB* >::Invoke(121 /* System.Type System.Type::MakeGenericType(System.Type[]) */, L_23, L_24);
...
IL_0045:
	{
		...
		NullCheck(L_20);
		Type_t* L_21;
		L_21 = VirtualFuncInvoker0< Type_t* >::Invoke(111 /* System.Type System.Type::get_BaseType() */, L_20);
		V_2 = L_21;
